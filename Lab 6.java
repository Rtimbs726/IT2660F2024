class Main {
  public static void main(String[] args) {
    // Use the instructions in Blackboard or instructions.md to complete Lab 6
        ...
        boolean hasIT1025 = creditHours.containsKey("IT-1025");
        boolean hasIT2110 = creditHours.containsKey("IT-2110");

        System.out.println("Contains IT-1025: " + hasIT1025); 
        System.out.println("Contains IT-2110: " + hasIT2110); 
